<template>
    ...
    function secondsBeforeSwitchExpires(checkInByTime, checkInIntervalInHours, lastCheckedIn) {
        ...
        // *********************************************************************************
        console.log(checkInByTime.toLocaleString())
...
// let checkInByHours = new Date(checkInByTime).getUTCHours();
// let checkInByMinutes = new Date(checkInByTime).getUTCMinute{s();
// let checkInBySeconds = new Date(checkInByTime).getUTCSeconds();
// let checkInByMilliseconds = new Date(checkInByTime).getUTCMilliseconds();
