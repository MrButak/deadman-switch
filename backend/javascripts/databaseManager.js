...
exports.insertNewDeadmanSwitch = async (userId, newSwitchData) => {
    ...
    let dbValues = [userId, new Date(Date.now()), newSwitchData.checkInIntervalInDays * 24, new Date(newSwitchData.checkInTime), new Date(newSwitchData.firstCheckedInAt), newSwitchData.recipientEmail,  newSwitchData.recipientFirstName,  newSwitchData.recipientLastName, newSwitchData.finalMessage, false];
